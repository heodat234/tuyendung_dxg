					      ...
					      <div class="panel-body" style="border: 0px">
					          <div class="width100">
					             ...
					             <div class="col-xs-3 width30 padding-lr0">
					             	...
					             	<select class="textbox2 js-example-basic-single" onchange="comb_tp_qh_1(this.value,0)" 
					             		name="city1" id="city1" style="width: 195px;">
						                 <option value="0" style="width: 195px" >Chọn tỉnh thành</option>
						                <?php foreach ($city as $key ) 
						                {
						                	$fdc = 0;
					                ...
					                <select class="seletext js-example-basic-single" name="district1" id="district1" style="width: 100%" required onchange="comb_qh_px_1(this.value,0)">
					                 	<option value="0" id="chonqh-ad1" >Chọn quận huyện</option>
					                </select>
					                <div class="h10-w-auto"></div>
					                 <select class="textbox2 js-example-basic-single" name="ward1" id="phuongxa8-ad" style="width: 100%" required>
					                ...
					                <div class="h10-w-auto"></div>
					                 ...
					                 ?></textarea>
					                 <div class="h10-w-auto"></div>
					                   <textarea class="form-control off-resize fontstyle" rows="2" name="addressno1" id="toanha8"
					                   ><?php 
					                 	if(isset($canaddress_noibo))
						                	{
						                		foreach ($canaddress_noibo as $value) {
					             ...
					             <div class="col-xs-3 width30 padding-lr0">
					             	...
					             	<div class="h10-w-auto"></div>
					             	<select class="textbox2 js-example-basic-single" id="city2" name="city2" style="width: 195px" onchange="comb_tp_qh_2(this.value,0)">
						                 <option value="0" style="width: 195px" >Chọn tỉnh thành</option>
						                <?php foreach ($city as $key ) 
						                {
						                	$fdc = 0;
					                ...
					                <div class="h10-w-auto"></div>
					                <select class="seletext js-example-basic-single" name="district2" id="district2" style="width: 100%" required onchange="comb_qh_px_2(this.value,0)">
					                 <option value="0" id="chonqh-ad2" >Chọn quận huyện</option>
					                </select>
					                <div class="h10-w-auto"></div>
					                 <select class="seletext js-example-basic-single" name="ward2" id="phuongxa8" style="width: 100%" required>
					                ...
					                <div class="h10-w-auto"></div>
					                 ...
					                 <div class="h10-w-auto"></div>
					                   <textarea class="form-control off-resize fontstyle" rows="2" name="addressno2" id="toanha8"
					                   ><?php 
					                 	if(isset($canaddress_noibo))
						                	{
						                		foreach ($canaddress_noibo as $value) {
					         ...
					         <button type="button" class="btn-luu-nav floatright margin-t35" <?php echo isset($candidate_noibo)? "" : "disabled";?> onclick="luu_diachi()"> Lưu</button>
					  	  </div>
					  	</form>
					    </div>
					    <!-- body ho so noi bo 3-->
	      	...
	      	<table class="width100">
	      		<?php foreach ($history as $row) { 
	      			...
	      			if(isset($row['type'])){
	      				...
	      				$fa 			= '<a onclick="loadMail('.$row['mailid'].')"><i class="fa fa-file-envelope-o star-icon1"></i></a>';
...
<script type="text/javascript">
	$(document).ready(function(){
	    	...
	    	if($('#city1').val() != '0')
	    	{
	    		 var city1 = $('#city1').val();
	    		 var get1 = $('#getqh1').val();
	    		 comb_tp_qh_1(city1,get1);
	    		 var get2 = $('#getpx1').val();
	    		 comb_qh_px_1(get1,get2);
	    	}
	    	if($('#city2').val() != '0')
	    	{
	    		 var city2 = $('#city2').val();
	    		 var get3 = $('#getqh2').val();
	    		 comb_tp_qh_2(city2,get3);
	    		  var get4 = $('#getpx2').val();
	    		 comb_qh_px_2(get3,get4);
	    	}
	...
	{
		$.ajax({
			url: '<?php echo base_url()?>admin/handling/update_diachi/<?php echo $candidate_noibo['candidateid']?>',
			type: 'POST',
			dataType: 'JSON',
