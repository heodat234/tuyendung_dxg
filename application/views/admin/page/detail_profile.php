			    		...
			    		<form id="form_canhan_<?php echo $candidate_noibo['candidateid'] ?>">
					         ...
					         <div class="width100">
					             ...
					             <div class="col-xs-3 width30 padding-lr0">
                                    ...
                                    <!-- <select class="textbox2 js-example-basic-single" name="nativeland" style="width: 100%">
                                         <option value="0" >Chọn tỉnh thành</option>
                                        <?php foreach ($city as $key ) {
					  	...
					  	<div class="panel panel-default border-rad0" id="tab2">
				    		...
				    		<form id="form_canhan_<?php echo $value['candidateid'] ?>">
						         ...
						         <div class="width100">
						             ...
						             <div class="col-xs-3 width30 padding-lr0">
                                        ...
                                        <select class="textbox2 js-example-basic-single" name="nativeland" style="width: 100%">
                                             <option value="0" >Chọn tỉnh thành</option>
                                            <?php foreach ($city as $key_c ) {
                                                if( isset($value['nativeland']) && $key_c['name'] == $value['nativeland'] )
                                                {
                                            ?>
                                            <option value="<?php echo $key_c['name'] ?>" selected><?php echo $key_c['name'] ?></option>
                                            <?php
                                 ...
                                 <div class="width100">
                                     ...
                                     <div class="col-xs-3 width30 padding-lr0">
                                        <select class="textbox2 js-example-basic-single" name="maritalstatus" style="width: 100%">
                                            <option value="S" <?php echo (isset($value['maritalstatus']) && $value['maritalstatus'] == 'S')? 'selected' : '' ?> >Độc thân</option>
                                            <option value="M" <?php echo (isset($value['maritalstatus']) && $value['maritalstatus'] == 'M')? 'selected' : '' ?> >Đã kết hôn</option>
                                            <option value="W" <?php echo (isset($value['maritalstatus']) && $value['maritalstatus'] == 'W')? 'selected' : '' ?> >Góa</option>
                                            <option value="D" <?php echo (isset($value['maritalstatus']) && $value['maritalstatus'] == 'D')? 'selected' : '' ?> >Ly dị</option>
                                        </select>
                                     </div>
                                 </div>
                                 <br><br>
	      		 ...
	      		 foreach ($history as $row) {
	      			...
	      			if(isset($row['type'])){
	      				...
	      				if ($row['actiontype'] == 'Trust') {
                            ...
                            $type       = ' - '.$row['actionnote'].' - Vị trí: '.$row['campaignname'].' - '.$createddate;
                            $check      = 1;
                        }
                            ...
                            $type       = ' - Nộp hồ sơ vào vị trí: '.$row['campaignname'].', ngày có thể làm việc: '.$row['actionnote'].' - '.$createddate;
                            $check      = 1;
                        }
