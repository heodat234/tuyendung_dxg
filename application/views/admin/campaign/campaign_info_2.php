<input type="hidden" name="filterid" id="filterid" value="<?php echo $filterid ?>">
    	...
    	<div class="box box-default">
				      	...
				      	<div class="panel-body ">
				      		<div class="row form_campaign">
				      			<div class="col-xs-4">
				      				...
				      				<input type="text" id="tiemnang_tu" class="input_hs_cam so100" placeholder="Từ" maxlength="3" onkeyup="testtiemnang()" value="<?php echo $f1 ?>">
				      				<input type="text" id="tiemnang_den" class="input_hs_cam so100" placeholder="Đến" maxlength="3" onkeyup="testtiemnang()" value="<?php echo $f1_1 ?>">
				      			</div>
				      			<div class="col-xs-4">
			...
			<div class="box_btn">
				...
				<div class=" pull-right">
					<a onclick="save_filter()" class="btn btn_tt">Lưu</a>
				</div>
			</div>
      	</div>
    </div>
	...
	function save_filter()
    {
      var value = {'gender' : '','placeofbirth' : '' , 'age': '' , 'height' : '',  'weight' : '', 'ethnic' : '', 'nationality' : '' , 'cityori' : '' , 'citycurr' : '' , 'district' : '' , 'currentbenefit' : '' , 'desirebenefit' : '' , 'experience' : '' , 'knowledge' : '' , 'language' : '' , 'software' : '' , 'maritalstatus' : '' , 'istalent' : '' , 'lastupdate' : '' , 'blocked' : '' , 'rate' : '' , 'tag' : '' , 'tagrandom' : ''};
       ...
       if($('#chk_diem').is(':checked'))
       {
        ...
        value['filterid'] = $('#filterid').val();
        $.ajax({
          url: '<?php echo base_url()?>admin/campaign/updateRound2',
          type: 'POST',
          dataType: 'json',
          data: value,
        })
